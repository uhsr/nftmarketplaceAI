// src/lib.rs
/*
 * Core library for nftmarketplace
 */
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting nftmarketplace processing");
    
    let mut processor = nftmarketplaceProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = nftmarketplaceProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = nftmarketplaceProcessor::new(false);
